"""
Authoritative role prompts for the IMO direct solver workflow.

These prompts are harness-agnostic. Both Claude Code and Codex Desktop
orchestrators use them identically. Adapted from Lin Yang and Yichen Huang.
"""
